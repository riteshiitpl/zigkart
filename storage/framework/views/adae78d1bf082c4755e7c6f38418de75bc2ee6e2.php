...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group cust_address">
                    ...
                    <input id="customer_address" type="text" class="form-control" name="user_address" placeholder="<?php echo e(__('Enter your Address')); ?>">
                </div>
                <div class="form-group cust_city">
                    <label for="password">City<span class="city_required required"></span></label>
                    <input id="customer_city" type="text" class="form-control" name="user_city" placeholder="<?php echo e(__('Enter your City')); ?>">
                </div>
                <div class="form-group cust_state">
                    <label for="password">State<span class="state_required required"></span></label>
                    <input id="customer_state" type="text" class="form-control" name="user_state" placeholder="<?php echo e(__('Enter your State')); ?>">
                </div>
                <div class="form-group cust_zipcode">
                    <label for="password">Zipcode<span class="zipcode_required required"></span></label>
                    <input id="customer_zipcode" type="text" class="form-control" name="user_zipcode" placeholder="<?php echo e(__('Enter your Zipcode')); ?>">
                </div>
             ...
             <button type="submit" class="btn btn-warning  btn-block rounded button-off"><?php echo e(Helper::translation(2212,$translate)); ?></button>
...
</script><?php /**PATH E:\ritesh\htdocs\Office\office\office\zigkart\zigkart\resources\views/auth/register.blade.php ENDPATH**/ ?>