            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(1922,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                   ...
                   <div class="col-md-12">
                     <div class="card">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                        <form action="<?php echo e(route('admin.add-coupon')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
...
</html><?php /**PATH D:\xampp\htdocs\zigkart\resources\views/admin/add-coupon.blade.php ENDPATH**/ ?>