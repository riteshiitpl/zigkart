            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(1911,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
...
<div class="content mt-3">
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade <?php if($i == 1): ?> show active <?php endif; ?> mt-4" id="<?php echo e($language->language_name); ?>" role="tabpanel">
              <div class="form-group">
                   <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(1914,$translate)); ?> <span class="require">*</span></label>
                   <input type="text" name="attribute_name[]" id="attribute_name" value=""   class="form-control" data-bvalidator="required">
              </div>
      ...
      <div class="form-group">
                   <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(2982,$translate)); ?> <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> <?php echo e(Helper::translation(2985,$translate)); ?><span class="require">*</span></label>
...
</html><?php /**PATH E:\ritesh\htdocs\Office\office\office\zigkart\zigkart\resources\views/admin/add-attribute-type.blade.php ENDPATH**/ ?>