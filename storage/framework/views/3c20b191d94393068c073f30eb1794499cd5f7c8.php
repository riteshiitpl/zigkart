            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(3069,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                          ...
                          <div class="col-md-8">
                             <div class="card-body">
                              ...
                              <div class="form-group">
                                                ...
                                                <option value="left"><?php echo e(Helper::translation(3084,$translate)); ?></option>
                                                <option value="right"><?php echo e(Helper::translation(3087,$translate)); ?></option>
                                                <option value="center"><?php echo e(Helper::translation(3090,$translate)); ?></option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1"><?php echo e(Helper::translation(2099,$translate)); ?> (<?php echo e(Helper::translation(3003,$translate)); ?> 1920 x 400) <span class="require">*</span></label>
