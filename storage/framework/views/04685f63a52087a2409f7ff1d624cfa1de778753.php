      ...
      <div class="breadcrumbs">
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade <?php if($i == 1): ?> show active <?php endif; ?> mt-4" id="<?php echo e($language->language_name); ?>" role="tabpanel">
              <div class="form-group">
                   ...
                   <input type="text" name="blog_category_name[]" id="blog_category_name" value="<?php if(!empty($view->blog_category_name)): ?><?php echo e($view->blog_category_name); ?><?php endif; ?>"   class="form-control" data-bvalidator="required">
              </div>
        ...
        <div class="form-group">
                              <label for="name" class="control-label mb-1">Slug <span class="require">*</span></label>
                                                <input id="blog_category_slug" name="blog_category_slug" type="text" class="form-control" value="<?php echo e($edit['category']->blog_category_slug); ?>" data-bvalidator="required">
                                            </div>         
                  <div class="form-group">
...
</html><?php /**PATH D:\xampp\htdocs\zigkart\resources\views/admin/edit-blog-category.blade.php ENDPATH**/ ?>