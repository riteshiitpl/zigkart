        ...
        <div class="login-form mt-5">
           <div class="main-div loginform col-md-5 mx-auto">
               ...
               <form action="<?php echo e(route('login')); ?>" method="POST" id="login_form">
                ...
                <button type="submit" class="btn btn-warning button-color btn-block rounded button-off"><?php echo e(Helper::translation(2041,$translate)); ?></button>
...
</html><?php /**PATH E:\ritesh\htdocs\Office\office\office\zigkart\zigkart\resources\views/auth/login.blade.php ENDPATH**/ ?>