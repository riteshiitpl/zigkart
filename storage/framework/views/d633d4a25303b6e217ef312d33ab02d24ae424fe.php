      ...
      <div class="col-md-12 mt-3">
        ...
        <?php echo e(csrf_field()); ?>
          ...
          <h3><?php echo e($shop->product_name); ?></h3>
            ...
            <?php if($shop->product_price_type == 'single_price'): ?>
                <?php if($shop->product_offer_price != 0): ?>
                    <span class="fs32 display_result"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_offer_price); ?>

                    </span>
                <?php else: ?>
                    <span class="fs32 display_result"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_price); ?></span>
                <?php endif; ?>
            <?php else: ?>
                <input type="hidden" name="price" class="bulk_quantity">
                <span class="fs32 display_result">
                    <?php echo e($allsettings->site_currency_symbol); ?><?php echo e(number_format(($shop->product_qty_1*$shop->product_price_1),2)); ?>
                ...
                <table class="table table-striped">
                    <tbody>
                        <tr>
                            <td><b>Qty</b></td>
                            <td class="text-center"><?php echo e($shop->product_qty_1); ?></td>
                            <td class="text-center"><?php echo e($shop->product_qty_2); ?></td>
                            <td class="text-center"><?php echo e($shop->product_qty_3); ?></td>
                            <td class="text-center"><?php echo e($shop->product_qty_4); ?></td>
                            <td class="text-center"><?php echo e($shop->product_qty_5); ?></td>
                            <td class="text-center"><?php echo e($shop->product_qty_6); ?></td>
                        </tr>
                        <tr>
                            <td><b>Price(<?php echo e($allsettings->site_currency_symbol); ?>)</b></td>
                            <td class="text-center"><?php echo e($shop->product_price_1); ?></td>
                            <td class="text-center"><?php echo e($shop->product_price_2); ?></td>
                            <td class="text-center"><?php echo e($shop->product_price_3); ?></td>
                            <td class="text-center"><?php echo e($shop->product_price_4); ?></td>
                            <td class="text-center"><?php echo e($shop->product_price_5); ?></td>
                            <td class="text-center"><?php echo e($shop->product_price_6); ?></td>
                        </tr>
                    </tbody>
                </table>
            <?php endif; ?>
            ...
            <?php endif; ?>
                                         ...
                                         <?php if($shop->product_type != 'digital'): ?>
                                           ...
                                           <?php else: ?>
                                                <span>
                                                  <label><?php echo e(Helper::translation(2145,$translate)); ?></label>
                                                  <input type="number" name="qty" class="form-control qty_bulk" id="qty_bulk" min="<?php echo e($shop->product_qty_1); ?>" data-bvalidator="required,min[<?php echo e($shop->product_qty_1); ?>]" value="<?php echo e($shop->product_qty_1); ?>">
                                               </span>
                                           <?php endif; ?>
              ...
              <button type="button" class="btn btn-success float-left ml-1 sellerMessage" data-toggle="modal">Message Seller</button>
              ...
              <button type="button" class="btn btn-success float-left ml-1 sellerMessage" data="<?php echo e($seller->id); ?>" data-toggle="modal" >Message Seller</button>
              <?php endif; ?>
            ...
            <!--  <div class="row">
                <div class="col-md-12">
                    <button type="button" class="btn btn-dark  sellerMessage" data-toggle="modal">Request a customize order</button>       
                </div>   
             </div>
              -->
             <div class="footer-box-info mt-3 mb-3 pt-3 pb-3 clearfix">
                
                <button type="button" class="btn btn-dark mb-3 form-control" data-toggle="modal" data-target="#customizeOrderModal">Request a customize order</button>  
                <br />
        ...
        <div class="card mt-3 tab-card" style="max-width: 100%;">
        ...
        <h4 class="black mb-2 pb-2 text-center"><?php echo e(Helper::translation(2152,$translate)); ?></h4>
                            ...
                            <?php $z = 1; ?>
                              ...
                              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-2 pb-2">
                               ...
                               <i class="fa fa-eye"></i>
                               <p class="quick_view"><?php echo e(Helper::translation(2060,$translate)); ?><br/><?php echo e(Helper::translation(2061,$translate)); ?></p>
                               </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="<?php echo e(route('inbox.store')); ?>" id="conversation_form"  enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        <input type="hidden" name="receiver_id" id="seller_id" value="">
        <input type="hidden" name="sender_id" value="<?php echo e(Auth::user()->id); ?>">
        <input type="hidden" name="inbox_id" value="new">
         <textarea name="message" class="form-control" id="" cols="45" rows="3" placeholder="<?php echo e(Helper::translation(2928,$translate)); ?>" data-bvalidator="required"></textarea><br>
...
<script type="text/javascript">var URL = <?php echo json_encode(url('/')); ?></script>
...
$(document).ready(function() { 
    ...
    $('#qty_bulk').change(function(){
      
      var quantity= $(this).val();
      var product_id = '<?php echo e($shop->product_id); ?>';

      $.ajax({
            url:"<?php echo e(url('product_price/')); ?>"+"/"+quantity+"/"+product_id,
            method:'get',
            data:{},
            success:function(data){ 
                // console.log(data);
                $('.display_result').text("<?php echo e($allsettings->site_currency_symbol); ?>" + data);
              },
        });

    });

    $('.sellerMessage').click(function(){
       $('#messageModal').modal('show');
       $('#seller_id').val($(this).attr('data'));
    });
...
<?php echo $__env->make('component.request_customize_order', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

</body>
</html>
<?php else: ?>
<?php echo $__env->make('503', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?><?php /**PATH E:\ritesh\htdocs\Office\office\office\zigkart\zigkart\resources\views/product.blade.php ENDPATH**/ ?>