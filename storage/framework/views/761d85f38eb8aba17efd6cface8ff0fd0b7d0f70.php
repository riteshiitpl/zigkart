            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(3240,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(3024,$translate)); ?> : </label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> <?php echo e(Helper::translation(3243,$translate)); ?><span class="require">*</span></label>
                                                <select name="language_default" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['view']->language_default == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1942,$translate)); ?></option>
                                                <option value="0" <?php if($edit['view']->language_default == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1943,$translate)); ?></option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['view']->language_status == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1916,$translate)); ?></option>
                                                <option value="0" <?php if($edit['view']->language_status == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1917,$translate)); ?></option>
                                                </select>
