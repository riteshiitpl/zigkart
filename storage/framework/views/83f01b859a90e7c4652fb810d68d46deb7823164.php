...
<?php if(Auth::user()->user_type == 'vendor'): ?>
    ...
    <main role="main">
     ...
     <div class="row mb-2">
           ...
           <a href="<?php echo e(url('/products-import-export')); ?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> <?php echo e(Helper::translation(2961,$translate)); ?></a>
           </div>
        </div>
     <div class="row">
...
<?php endif; ?><?php /**PATH E:\ritesh\htdocs\Office\office\office\zigkart\zigkart\resources\views/my-product.blade.php ENDPATH**/ ?>