    ...
    <div class="row">
        ...
        <div class="col-md-10 RTFT">
             ...
             <?php echo e(csrf_field()); ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="inputContactNumber"><?php echo e(Helper::translation(2003,$translate)); ?><span class="required">*</span></label>
                        <input type="text" class="form-control" id="user_address" name="user_address" value="<?php echo e($edit['profile']->user_address); ?>" data-bvalidator="required">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputContactNumber">City<span class="required">*</span></label>
                        <input type="text" class="form-control" id="user_city" name="user_city" value="<?php echo e($edit['profile']->user_city); ?>" data-bvalidator="required">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="inputContactNumber">State<span class="required">*</span></label>
                        <input type="text" class="form-control" id="user_state" name="user_state" value="<?php echo e($edit['profile']->user_state); ?>" data-bvalidator="required">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputContactNumber">Zipcode<span class="required">*</span></label>
                        <input type="text" class="form-control" id="user_zipcode" name="user_zipcode" value="<?php echo e($edit['profile']->user_zipcode); ?>" data-bvalidator="required">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
...
<?php endif; ?><?php /**PATH E:\ritesh\htdocs\Office\office\office\zigkart\zigkart\resources\views/my-profile.blade.php ENDPATH**/ ?>