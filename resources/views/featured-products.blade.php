...
<html lang="en">
<head>
<title>{{ Helper::translation(3060,$translate) }} {{ Helper::translation(1975,$translate) }} - {{ $allsettings->site_title }}</title>
@include('style')
</head>
<body>
@include('header')
    <section class="headerbg" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_header_background }}');">
      <div class="container text-left">
        <h2 class="mb-0">{{ Helper::translation(3060,$translate) }} {{ Helper::translation(1975,$translate) }}</h2>
        <p class="mb-0"><a href="{{ URL::to('/') }}">{{ Helper::translation(1913,$translate) }}</a> <span class="split">&gt;</span> <span>{{ Helper::translation(3060,$translate) }} {{ Helper::translation(1975,$translate) }}</span></p>
      </div>
    </section>
  <main role="main">
