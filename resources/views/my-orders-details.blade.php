           ...
           <div class="col-md-10">
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        ...
                        @if($purchase->payment_status == 'completed') <small style="color:green;">{{ Helper::translation(2084,$translate) }}@else<small style="color:red;">{{ Helper::translation(2085,$translate) }}</small>@endif</small>
