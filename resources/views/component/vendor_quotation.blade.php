  ...
  <div class="modal-dialog" role="vendor_quotation">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="customize_order_form" method="post" action="{{ route('vendor_quotation') }}"  enctype="multipart/form-data">
          @csrf
          ...
          <input type="hidden" name="customize_request_order_id" value="{{ $messageList[0]->customize_request_order_id}}">
