...
<link rel="stylesheet" type="text/css" href="{{ url('public/new_assets/css/style.css') }}">
...
.setting_form,.col-md-10{
       padding: 21px 15px 35px 15px !important; 
...
.table-responsive{
    ...
    box-shadow: 1px 1px 3px 3px #e2e2e26e !important;
