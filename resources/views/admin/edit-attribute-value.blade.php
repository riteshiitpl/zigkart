    ...
    <div id="right-panel" class="right-panel">
      ...
      <div class="form-group">
                   <label for="name" class="control-label mb-1">{{ Helper::translation(2982,$translate) }} <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                   <label for="name" class="control-label mb-1">{{ Helper::translation(1934,$translate) }} ({{ $allsettings->site_currency_symbol }})</label>
                                                <input id="attribute_value_price" name="attribute_value_price" type="text" class="form-control" data-bvalidator="min[1]" value="{{ $edit['value']->attribute_value_price }}">
                                            </div>
                                       <div class="form-group">
