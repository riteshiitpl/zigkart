            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(2021,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="flash_deal_start_date" name="coupon_start_date" type="text" class="form-control noscroll_textarea" value="{{ $edit['value']->coupon_start_date }}" data-bvalidator="required"> 
                                            </div>
                                            <div class="form-group">
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                                ...
                                                <input id="flash_deal_end_date" name="coupon_end_date" type="text" class="form-control noscroll_textarea" value="{{ $edit['value']->coupon_end_date }}" data-bvalidator="required"> 
                                            </div>
                                    ...
                                    <div class="form-group">
                                                ...
                                                <option value="{{ $vendor->id }}" @if($edit['value']->user_id == $vendor->id) selected @endif>{{ $vendor->username }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                            @else
