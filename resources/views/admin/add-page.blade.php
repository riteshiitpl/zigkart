            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(3027,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade @if($i == 1) show active @endif mt-4" id="{{ $language->language_name }}" role="tabpanel">
              ...
              <div class="form-group">
                  ...
                  <textarea name="page_desc[]" id="summary-ckeditor{{ $language->language_id }}" rows="6" placeholder="page description" class="form-control" data-bvalidator="required"></textarea>
              </div>            
          </div>
          ...
          @endforeach
                             ...
                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> {{ Helper::translation(3039,$translate) }}<span class="require">*</span></label>
