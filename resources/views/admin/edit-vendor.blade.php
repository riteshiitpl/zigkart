            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(3261,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="password" class="control-label mb-1">{{ Helper::translation(2102,$translate) }}</label>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="name" name="user_address" type="text" class="form-control" value="{{ $edit['userdata']->user_address }}" data-bvalidator="required">
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">City<span class="require">*</span></label>
                                                <input id="username" name="user_city" type="text" class="form-control" value="{{ $edit['userdata']->user_city }}" data-bvalidator="required">
                                            </div>
                                            <div class="form-group">
                                                    <label for="email" class="control-label mb-1">State<span class="require">*</span></label>
                                                    <input id="email" name="user_state" type="text" class="form-control" value="{{ $edit['userdata']->user_state }}" data-bvalidator="required">
                                            </div>
                                            <input type="hidden" name="user_type" value="vendor">
                                            <div class="form-group">
                                                    <label for="password" class="control-label mb-1">Zipcode<span class="require">*</span></label>
                                                    <input id="password" name="user_zipcode" type="text" class="form-control" value="{{ $edit['userdata']->user_zipcode }}" data-bvalidator="required">
                                             </div>
                                           </div>
                                </div>
                               </div>
