                       ...
                       <div class="card">
                         ...
                         <div class="card-body">
                           ...
                           <div class="card-body">
                            ...
                            <div class="col-md-12" style="display:none;"><div class="card-body"><h4>{{ Helper::translation(3693,$translate) }}</h4></div></div>
                            ...
                            <div class="col-md-12" style="display:none;"><div class="card-body"><h4>{{ Helper::translation(3708,$translate) }}</h4></div></div>
                            <div class="col-md-6" style="display:none;">
                            ...
                            <div class="col-md-12" style="display:none;"><div class="card-body"><h4>{{ Helper::translation(3720,$translate) }}</h4></div></div>
                            <div class="col-md-6" style="display:none;">
                            ...
                            <div class="col-md-12" style="display:none;"><div class="card-body"><h4>{{ Helper::translation(3732,$translate) }}</h4></div></div>
                            <div class="col-md-6" style="display:none;">
