            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(3264,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                          <label for="site_title" class="control-label mb-1">{{ Helper::translation(3267,$translate) }} <span class="require">*</span></label>
                            ...
                            <div class="col-md-6">
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3270,$translate) }} <span class="require">*</span></label>
                             ...
                             <div class="col-md-12"><div class="card-body"><h4>{{ Helper::translation(3273,$translate) }}</h4></div></div>
                             <div class="col-md-6">
                               <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3276,$translate) }} <span class="require">*</span></label>
                                    ...
                                    <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3279,$translate) }} <span class="require">*</span></label>
                                                ...
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3282,$translate) }}</label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3285,$translate) }} <span class="require">*</span></label>
                                   ...
                                   <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3288,$translate) }} </label>
                                                ...
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3291,$translate) }} </label>
