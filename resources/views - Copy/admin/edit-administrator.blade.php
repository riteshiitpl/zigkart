            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(3219,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                              ...
                                              <input type="hidden" name="user_type" value="admin">
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="user_photo" name="user_photo" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="{{ Helper::translation(1937,$translate) }}">@if($edit['userdata']->user_photo != '')
                            ...
                            <div class="col-md-6">
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                  <div class="form-group">
                                    <label for="customer_earnings" class="control-label mb-1"><strong>{{ Helper::translation(2976,$translate) }}</strong></label><br/><br/>
