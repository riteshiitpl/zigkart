          ...
          <div class="tab-pane fade @if($i == 1) show active @endif mt-4" id="{{ $language->language_name }}" role="tabpanel">
             <div class="form-group row">
               <div class="col-sm-12">
                        ...
                        <input id="attribute_name" name="attribute_name[]" type="text" class="form-control" value="@if(!empty($view->attribute_name)){{ $view->attribute_name }}@endif" data-bvalidator="required">
                    </div>
